...
export const updateUser = createAsyncThunk(
 "user/updateUser",
 async ({ id, referenceBusinessId, token }, { rejectWithValue }) => {
  try {
   const formData = new FormData();
   formData.append("referenceBusinessId", referenceBusinessId);

   const { data } = await axios.post(`${BASE_URL}/user/${id}`, formData, {
    headers: {
