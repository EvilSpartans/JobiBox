          ...
          <div className="flex flex-col justify-center min-h-[60%] h-fit tall:h-[90%] w-fit min-w-[60%] tall:w-[90%] space-y-8 tall:space-y-20 p-10 dark:bg-dark_bg_2 rounded-xl">
            ...
            <div className="text-center dark:text-dark_text_1">
              ...
              <p className="mt-6 text-base">
                {" "}
                Voici comment va se dérouler ton{" "}
                <span className="text-blue-400">épreuve :</span>
              </p>

              <p className="mt-6 text-base">
                Ton référant t'a préparé une{" "}
                <span className="text-blue-400">série de questions</span>{" "}
                auxquelles tu vas devoir répondre dans un format vidéo.
              </p>

              <p className="mt-6 text-base">
                Pour chacune d'entre elle, tu auras la possibilité de visionner
                plusieurs fois la séquence question, avant de te lancer dans
                l'enregistrement de ta réponse.
              </p>

              <p className="mt-6 text-base">
                Une fois cette étape terminée, le montage se fera
                automatiquement, et tu arriveras sur l'écran de publication.
              </p>
            </div>
            <button
