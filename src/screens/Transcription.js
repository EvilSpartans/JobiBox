	...
	return (
		<div className="h-screen dark:bg-dark_bg_1 flex items-center justify-center py-[19px] overflow-hidden">
			...
			<Tuto
				steps={[
					{
						intro: "Si tu le souhaites, tu peux ajouter les sous-titres automatiques afin de rendre ton CV vidéo dynamique et plus compréhensible. N’hésite pas à les relire afin de voir si tout est correct."
					}
				]}
