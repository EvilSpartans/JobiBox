...
import { ModalThemeProps } from "../../models/Theme";

export default function ModalTheme({ isOpen, onClose, fetchThemes }: ModalThemeProps) {
    
    const user = useSelector((state: RootState) => state.user.user);
    const { token } = user;
    const [newThemeTitle, setNewThemeTitle] = useState<string>("");
    const [newThemeImage, setNewThemeImage] = useState<File | null>(null);
