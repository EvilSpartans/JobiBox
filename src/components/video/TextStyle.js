    ...
    return (
        <div className="w-full max-w-md space-y-8 p-10 dark:bg-dark_bg_2 rounded-xl">
            <div className="text-center dark:text-dark_text_1">
                ...
                <p className="mt-6 text-sm">Ajustez la taille et la couleur de vos questions</p>
            </div>
            <div className="dark:text-dark_text_1">
                <div className="mb-8">
                    ...
                    <div className="mt-8 flex items-center justify-center">
                        <CirclePicker color={textStyle.textColor} onChange={handleTextColorChange} />
                    </div>
                </div>
            </div>
            <button
                ...
                steps={[
                    {
                        ...
                        intro: 'Tu peux ajuster la taille de tes questions en faisant glisser ce curseur.',
                    },
                    {
