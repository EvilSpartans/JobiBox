...
import { getVideoProcesses, changeStatus, deleteVideoProcess, compileVideoProcess, updateVideoProcess } from "../../store/features/videoProcessSlice";
...
export default function Clip() {
    ...
    const handleDelete = async (index) => {
        ...
        try {
            const response = await dispatch(deleteVideoProcess({
                token: token,
                id: questions[index].id,
            }));
        ...
        <div className="w-full max-w-md space-y-8 p-10 dark:bg-dark_bg_2 rounded-xl">
            ...
            <div className="dark:text-dark_text_1">
                ...
                {showModalOpen && selectedQuestionIndex !== null && (
                    <div className="fixed inset-0 flex items-center justify-center z-50">
                        <div className="absolute inset-0 bg-gray-900 opacity-75" onClick={closeShowModal}></div>
                        <div className="relative flex items-center justify-center">
                            <div style={{ height: '80vh' }} className="modal-content bg-white p-4 rounded-lg h-screen max-h-screen overflow-hidden">
                                <video
                ...
                {editModalOpen && selectedQuestionIndex !== null && (
                    <div className="fixed inset-0 flex items-center justify-center z-50">
                        <div className="absolute inset-0 bg-gray-900 opacity-75" onClick={closeEditModal}></div>
                        <div className="relative flex items-center justify-center">
                            <div className="modal-content bg-white p-4 rounded-lg text-center z-50 relative">
                                <p className="text-gray-800 text-lg">
                                    Scinder le clip
                                </p>
                                <div style={{ height: '50vh' }} className="modal-content bg-white p-4 rounded-lg h-screen max-h-screen overflow-hidden">
                                    <video
                                        ref={(ref) => {
                                ...
                                <p className="text-gray-500 text-sm">Début : {startValue} - Fin : {endValue}</p>
                                <Slider
                                    range
                                    min={0}
                                    step={0.1}
            ...
            <Tuto
                steps={[
                    {
                        element: '.addButton',
                        intro: "Si tu as oublié d'aborder un sujet, il est encore possible d'ajouter une question !",
                    },
                    {
                        element: '.showIcon',
                    ...
                    {
                        intro: "Lorsque chaque séquence est parfaite, tu peux cliquer sur continuer et laisser la magie de la Jobibox opérer."
                    }
                ]}
