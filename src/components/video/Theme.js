    ...
    return (
        <div className="w-full max-w-md space-y-8 p-10 dark:bg-dark_bg_2 rounded-xl">
            ...
            <div className="text-center dark:text-dark_text_1">
                ...
                <p className="mt-6 text-sm">Sélectionnez le thème qui vous correspond</p>
            </div>
            <div className="dark:text-dark_text_1">
                ...
                <Slider {...sliderSettings}>
                    ...
                    {themes.map((theme, index) => (
                        <div
                            key={index}
                            className={`relative rounded-lg cursor-pointer mb-2 mx-2 ${selectedThemeIndex === index ? "theme-selected" : ""}`}
                ...
                steps={[
                    {
                        ...
                        intro: 'Tu as sélectionné tes questions, tu peux maintenant choisir un fond de couleur (ou Template) sur lequel tes questions seront notées.',
                    },
                ]}
