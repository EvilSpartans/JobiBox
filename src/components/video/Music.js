            ...
            <div className="dark:text-dark_text_1">
                <div className="audio-player mt-4">
                    <audio controls id="music-player" className="w-full">
                        <source src={selectedMusic && selectedMusic.music ? BASE_URL + selectedMusic.music : ""} />
                    </audio>
                </div>
                ...
                {loading ? (
                    ...
                    <div className="flex flex-wrap mt-6" style={{ maxHeight: "350px", overflowY: "auto" }}>
                        {/* New music */}
                        ...
                        {musics.map((music, index) => (
                            <div key={index} className="w-1/3 mb-4 p-2">
                                <label
                                    className={`block relative border-2 p-3 rounded-lg ${index === selectedLabel ? "theme-selected" : "border-gray-300"} hover:cursor-pointer`}
                                >
                                    <div className="music-icon">
                                        <img
            ...
            <Tuto
                steps={[
                    ...
                    // },
                    {
                        ...
                        intro: 'Tu peux maintenant sélectionner une musique qui correspond le plus à ta personnalité.',
                    },
                ]}
