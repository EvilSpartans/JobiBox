...
import InterestsAndMore from '../screens/resume/InterestsAndMore';
...
const ResumeRoutes = ({ token }) => [
    ...
    <Route key="interestsAndMore" path="/interestsAndMore" element={token ? <InterestsAndMore /> : <Navigate to="/welcome" />} />,
